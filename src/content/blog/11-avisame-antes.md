...
Cambié el enfoque: si bien el objetivo es el mismo, mi plan es avisarme qué en dos horas debo estar listo para *salir al gimnasio*. **No estar en el lugar, sino salir para allá**. Obviamente el tiempo da para no arribar cuando el gerente-mamado esté bajando la cortina. Si tengo hambre, como algo ligero; si estoy en medio de una tarea que me exige concentración, la acoto a pausarla en un punto clave. Es decir, es un aviso previo de lo que *tiene que suceder en un rango de tiempo, no en un monento en específico.* Es engañar al propio cerebro, pero parece que funciona.
